...
function downloadICS() {
  const title = "Demo: Reunión de proyecto";
  const description = "Reunión para revisar avances y próximos pasos.";
  const location = "Ciudad de México";
  const startDate = "20250720T090000"; // YYYYMMDDTHHMMSS formato UTC o local
  const endDate = "20250720T100000";
